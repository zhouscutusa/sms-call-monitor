...
public interface IConstants {
    ...
    static final long WIFI_OFF_DELAY_MS = TimeUnit.MINUTES.toMillis(5); // 5分钟 Wi-Fi 关闭延迟
    // 等待网络连接的超时和间隔
    ...
    static final int SCHEDULED_WORK_INTERVAL_MINUTE = 30;// 每隔30分钟尝试把之前没发送出去的任务发送一下
}
